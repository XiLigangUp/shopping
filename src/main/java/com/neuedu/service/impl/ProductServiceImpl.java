 ...
 * */
    ...
    public ServerResponse saveOrUpdate(Product product) {
        ...
        //step2:设置商品的主图sub_images-->1.jpg,2.jpg,3.png
       String subImages=product.getSubImages();
        if (subImages!=null&&!subImages.equals("")){
           String[] subimageArr= subImages.split(",");//按照“，”隔开，得到字符串窜数组
    ...
    public ServerResponse detail(Integer productId) {
        ...
        //step3:做转换product-->productDetailVO
    ...
    public ServerResponse search(Integer productId, String productName, Integer pageNum, Integer pageSize) {
        ...
        //step1:select * from product where productId ? and productName like %name%
        PageHelper.startPage(pageNum,pageSize);
...
//获取图片名称
    ...
    public ServerResponse list_portal(Integer categoryId, String keyword, Integer pageNum, Integer pageSize, String orderBy) {
        ...
        //step1:参数校验categoryId和keyword不能同时为空
